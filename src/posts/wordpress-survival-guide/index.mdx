...
import godzillaDance from "./godzilla-dance.webp";
import japaneseSeoSpam from "./japanese-seo-spam.webp";
import siteIsolationDiagram from "./site-isolation-diagram.webp";

<PostImage src={godzillaDance} alt="Godzilla Vibes" unoptimized priority />
...
<PostImage src={japaneseSeoSpam} alt="seo spam screenshot" />
...
<PostImage src={siteIsolationDiagram} alt="site isolation diagram" />
