...
1. **Fix the `/og` image route** (High, ~1 hr) — unblocks social + AI previews for all 20 posts at once. Do first; isolated and highest-impact.
2. **Add self-referencing canonicals + fix sitemap apex slash** (Medium, ~30 min).
3. **Deepen 3–4 flagship posts to 700+ words** (Medium, ongoing) — biggest long-term ranking/citation lever.
4. **Unique homepage/logs meta descriptions + fix heading levels** (Medium, ~30 min).
5. **Security headers + `llms.txt` + schema enrichment** (Low, backlog).
